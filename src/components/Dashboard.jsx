...
const Dashboard = () => {
  return (
   <div className="simplebar-mask"><div className="simplebar-offset" style={{right: 0, bottom: 0}}><div className="simplebar-content-wrapper" tabIndex={0} role="region" aria-label="scrollable content" style={{height: '100%', overflow: 'hidden scroll'}}><div className="simplebar-content" style={{padding: 0}}>
        <div className="twocolumn-menu-item menuitem-active d-block" id="dashboard">
          <div className="title-box show">
            <h5 className="menu-title">Dashboards</h5>
            <ul className="nav flex-column">
              <li className="nav-item menuitem-active">
                <a className="nav-link active" href="index.html">Dashboard 1</a>
              </li>
              <li className="nav-item">
                <a className="nav-link" href="dashboard-2.html">Dashboard 2</a>
              </li>
              <li className="nav-item">
                <a className="nav-link" href="dashboard-3.html">Dashboard 3</a>
              </li>
              <li className="nav-item">
                <a className="nav-link" href="dashboard-4.html">Dashboard 4</a>
              </li>
            </ul>
          </div>
        </div>
        <div className="twocolumn-menu-item" id="apps">
          ...
          <ul className="nav flex-column">
            ...
            <li className="nav-item">
              <a href="#sidebarEcommerce" data-bs-toggle="collapse" className="nav-link">
                <span> Ecommerce </span>
            ...
            <li className="nav-item">
              <a href="#sidebarCrm" data-bs-toggle="collapse" className="nav-link">
                <span> CRM </span>
                <span className="menu-arrow" />
              </a>
            ...
            <li className="nav-item">
              <a href="#sidebarEmail" data-bs-toggle="collapse" className="nav-link">
                <span> Email </span>
                <span className="menu-arrow" />
              </a>
            ...
            <li className="nav-item">
              <a className="nav-link" href="apps-social-feed.html">Social Feed</a>
            </li>
            <li className="nav-item">
              <a className="nav-link" href="apps-companies.html">Companies</a>
            </li>
            <li className="nav-item">
              <a href="#sidebarProjects" data-bs-toggle="collapse" className="nav-link">
                <span> Projects </span>
                <span className="menu-arrow" />
              </a>
            ...
            <li className="nav-item">
              <a href="#sidebarTasks" data-bs-toggle="collapse" className="nav-link">
                <span> Tasks </span>
                <span className="menu-arrow" />
              </a>
            ...
            <li className="nav-item">
              <a href="#sidebarContacts" data-bs-toggle="collapse" className="nav-link">
                <span> Contacts </span>
                <span className="menu-arrow" />
              </a>
            ...
            <li className="nav-item">
              <a href="#sidebarTickets" data-bs-toggle="collapse" className="nav-link">
                <span> Tickets </span>
                <span className="menu-arrow" />
              </a>
            ...
            <li className="nav-item">
              <a className="nav-link" href="apps-file-manager.html">File Manager</a>
            </li>
          </ul>
        </div>
        <div className="twocolumn-menu-item" id="pages">
          <div className="title-box">
            ...
            <ul className="nav flex-column">
              ...
              <li className="nav-item">
                <a className="nav-link" href="pages-sitemap.html">Sitemap</a>
              </li>
              <li className="nav-item">
                <a className="nav-link" href="pages-invoice.html">Invoice</a>
              </li>
              <li className="nav-item">
                <a className="nav-link" href="pages-faqs.html">FAQs</a>
              </li>
              <li className="nav-item">
                <a className="nav-link" href="pages-search-results.html">Search Results</a>
              </li>
              <li className="nav-item">
              ...
              <li className="nav-item">
                <a className="nav-link" href="pages-coming-soon.html">Coming Soon</a>
              </li>
              <li className="nav-item">
                <a className="nav-link" href="pages-gallery.html">Gallery</a>
              </li>
              <li className="nav-item">
                <a href="#sidebarAuth" data-bs-toggle="collapse" className="nav-link">
              ...
              <li className="nav-item">
                <a href="#sidebarErrors" data-bs-toggle="collapse" className="nav-link">
        ...
        <div className="twocolumn-menu-item" id="layouts">
          <div className="title-box">
            ...
            <ul className="nav flex-column">
              <li className="nav-item">
                <a className="nav-link" href="layouts-vertical.html">Vertical</a>
              </li>
              <li className="nav-item">
                <a className="nav-link" href="layouts-horizontal.html">Horizontal</a>
              </li>
              <li className="nav-item">
                <a className="nav-link" href="layouts-detached.html">Detached</a>
              </li>
              <li className="nav-item">
                <a className="nav-link" href="layouts-two-tone-icons.html">Two Tones Icons</a>
              </li>
              <li className="nav-item">
                <a className="nav-link" href="layouts-preloader.html">Preloader</a>
              </li>
            </ul>
          </div>
        </div>
        <div className="twocolumn-menu-item" id="uielements">
          <div className="title-box">
            ...
            <ul className="nav flex-column">
              ...
              <li className="nav-item">
                <a className="nav-link" href="ui-avatars.html">Avatars</a>
              </li>
              <li className="nav-item">
                <a className="nav-link" href="ui-portlets.html">Portlets</a>
              </li>
              <li className="nav-item">
              ...
              <li className="nav-item">
                <a className="nav-link" href="ui-notifications.html">Notifications</a>
              </li>
              <li className="nav-item">
                <a className="nav-link" href="ui-offcanvas.html">Offcanvas</a>
              </li>
              <li className="nav-item">
                <a className="nav-link" href="ui-placeholders.html">Placeholders</a>
              </li>
              <li className="nav-item">
              ...
              <li className="nav-item">
                <a className="nav-link" href="ui-carousel.html">Carousel</a>
              </li>
              <li className="nav-item">
                <a className="nav-link" href="ui-list-group.html">List Group</a>
              </li>
              <li className="nav-item">
                <a className="nav-link" href="ui-video.html">Embed Video</a>
              </li>
              <li className="nav-item">
                <a className="nav-link" href="ui-dropdowns.html">Dropdowns</a>
              </li>
              <li className="nav-item">
                <a className="nav-link" href="ui-ribbons.html">Ribbons</a>
              </li>
              <li className="nav-item">
                <a className="nav-link" href="ui-tooltips-popovers.html">Tooltips &amp; Popovers</a>
              </li>
              <li className="nav-item">
                <a className="nav-link" href="ui-general.html">General UI</a>
              </li>
              <li className="nav-item">
                <a className="nav-link" href="ui-typography.html">Typography</a>
              </li>
              <li className="nav-item">
                <a className="nav-link" href="ui-grid.html">Grid</a>
              </li>
            </ul>
          </div>
        </div>
        <div className="twocolumn-menu-item" id="components">
          <div className="title-box">
            ...
            <ul className="nav flex-column">
              <li className="nav-item">
                <a href="#sidebarExtendedui" data-bs-toggle="collapse" className="nav-link">
              ...
              <li className="nav-item">
                <a href="#sidebarIcons" data-bs-toggle="collapse" className="nav-link">
                  <span> Icons </span>
                  <span className="menu-arrow" />
                </a>
              ...
              <li className="nav-item">
                <a href="#sidebarForms" data-bs-toggle="collapse" className="nav-link">
                  <span> Forms </span>
                  <span className="menu-arrow" />
                </a>
              ...
              <li className="nav-item">
                <a href="#sidebarTables" data-bs-toggle="collapse" className="nav-link">
                  <span> Tables </span>
                  <span className="menu-arrow" />
                </a>
              ...
              <li className="nav-item">
                <a href="#sidebarCharts" data-bs-toggle="collapse" className="nav-link">
                  <span> Charts </span>
                  <span className="menu-arrow" />
                </a>
              ...
              <li className="nav-item">
                <a href="#sidebarMaps" data-bs-toggle="collapse" className="nav-link">
                  <span> Maps </span>
                  <span className="menu-arrow" />
                </a>
              ...
              <li className="nav-item">
                <a href="#sidebarMultilevel" data-bs-toggle="collapse" className="nav-link">
