      ...
      <div className="tab-pane active" id="settings-tab" role="tabpanel">
        ...
        <div className="p-3">
          ...
          <div className="form-check form-switch mb-1">
            <input type="checkbox" className="form-check-input" name="layout-color" defaultValue="light" id="light-mode-check" defaultChecked />
            <label className="form-check-label" htmlFor="light-mode-check">Light Mode</label>
          </div>
          <div className="form-check form-switch mb-1">
            <input type="checkbox" className="form-check-input" name="layout-color" defaultValue="dark" id="dark-mode-check" />
          ...
          <div className="form-check form-switch mb-1">
            <input type="checkbox" className="form-check-input" name="layout-width" defaultValue="fluid" id="fluid-check" defaultChecked />
            <label className="form-check-label" htmlFor="fluid-check">Fluid</label>
          </div>
          <div className="form-check form-switch mb-1">
            <input type="checkbox" className="form-check-input" name="layout-width" defaultValue="boxed" id="boxed-check" />
          ...
          <div className="form-check form-switch mb-1">
            <input type="checkbox" className="form-check-input" name="leftbar-color" defaultValue="light" id="light-check" />
            <label className="form-check-label" htmlFor="light-check">Light</label>
          </div>
          <div className="form-check form-switch mb-1">
            <input type="checkbox" className="form-check-input" name="leftbar-color" defaultValue="dark" id="dark-check" defaultChecked />
            <label className="form-check-label" htmlFor="dark-check">Dark</label>
          </div>
          <div className="form-check form-switch mb-1">
            <input type="checkbox" className="form-check-input" name="leftbar-color" defaultValue="brand" id="brand-check" />
            <label className="form-check-label" htmlFor="brand-check">Brand</label>
          </div>
          <div className="form-check form-switch mb-3">
            <input type="checkbox" className="form-check-input" name="leftbar-color" defaultValue="gradient" id="gradient-check" />
          ...
          <div className="form-check form-switch mb-1">
            <input type="checkbox" className="form-check-input" name="topbar-color" defaultValue="dark" id="darktopbar-check" defaultChecked />
            <label className="form-check-label" htmlFor="darktopbar-check">Dark</label>
          </div>
          <div className="form-check form-switch mb-1">
            <input type="checkbox" className="form-check-input" name="topbar-color" defaultValue="light" id="lighttopbar-check" />
          ...
          <div className="d-grid mt-4">
            ...
            <a href="https://1.envato.market/uboldadmin" className="btn btn-danger mt-3" target="_blank"><i className="mdi mdi-basket me-1" /> Purchase Now</a>
          </div>
        </div>
      </div>
    </div>
